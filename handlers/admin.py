...
async def make_changes_command(message:types.Message):
    ...
    await bot.send_message(message.from_user.id,'Что надо хозяин???', reply_markup=admin_kb.button_case_admim)
...
# Ловим четвертый ответ и используем полученный данные
